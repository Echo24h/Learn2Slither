...
class QLearning:
    ...
    def __step(self, action: str, snake: Snake,
               food: Food) -> tuple[dict[str, str], int, bool]:
        reward = 0
        done = False
    ...
    def run(self) -> None:
        ...
        for episode in range(self.__episodes):
            ...
            print(f"Episode {episode + 1}/{self.__episodes} finished "
                  ...
                  f"Exploration: {self.__q_data.exploration_rate}")
